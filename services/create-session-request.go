...
func NewCreateSessionRequest(reqHeader *RequestHeader, desc *ApplicationDescription, serverURI, endpoint, sessionName string, nonce, cert []byte, timeout uint64, maxRespSize uint32) *CreateSessionRequest {
