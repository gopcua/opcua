...
func NodeIDTypeFromString(s string) NodeIDType {
	switch s {
		case "TwoByte": return 0
		case "FourByte": return 1
		case "Numeric": return 2
		case "String": return 3
		case "Guid": return 4
		case "ByteString": return 5
		default:
		return 0
	}
}
...
func IdentityCriteriaTypeFromString(s string) IdentityCriteriaType {
	switch s {
		...
		case "Thumbprint": return 2
		case "Role": return 3
		case "GroupId": return 4
		case "Anonymous": return 5
		case "AuthenticatedUser": return 6
		default:
		return 0
	}
}
...
func TrustListMasksFromString(s string) TrustListMasks {
	switch s {
		case "None": return 0
		case "TrustedCertificates": return 1
		case "TrustedCrls": return 2
		case "IssuerCertificates": return 4
		case "IssuerCrls": return 8
		case "All": return 15
		default:
		return 0
	}
...
func DataSetFieldContentMaskFromString(s string) DataSetFieldContentMask {
	switch s {
		...
		case "SourceTimestamp": return 2
		case "ServerTimestamp": return 4
		case "SourcePicoSeconds": return 8
		case "ServerPicoSeconds": return 16
		case "RawData": return 32
		default:
		return 0
	}
}
...
func OverrideValueHandlingFromString(s string) OverrideValueHandling {
	switch s {
		case "Disabled": return 0
		case "LastUsableValue": return 1
		case "OverrideValue": return 2
		default:
		return 0
	}
}
...
func DataSetOrderingTypeFromString(s string) DataSetOrderingType {
	switch s {
		...
		case "AscendingWriterId": return 1
		case "AscendingWriterIdSingle": return 2
		default:
		return 0
	}
}
...
func UADPNetworkMessageContentMaskFromString(s string) UADPNetworkMessageContentMask {
	switch s {
		case "None": return 0
		case "PublisherId": return 1
		case "GroupHeader": return 2
		case "WriterGroupId": return 4
		case "GroupVersion": return 8
		case "NetworkMessageNumber": return 16
		case "SequenceNumber": return 32
		case "PayloadHeader": return 64
		case "Timestamp": return 128
		case "PicoSeconds": return 256
		case "DataSetClassId": return 512
		case "PromotedFields": return 1024
		default:
		return 0
	}
}
...
func UADPDataSetMessageContentMaskFromString(s string) UADPDataSetMessageContentMask {
	switch s {
		...
		case "PicoSeconds": return 2
		case "Status": return 4
		case "MajorVersion": return 8
		case "MinorVersion": return 16
		case "SequenceNumber": return 32
		default:
		return 0
	}
...
func JSONNetworkMessageContentMaskFromString(s string) JSONNetworkMessageContentMask {
	switch s {
		case "None": return 0
		case "NetworkMessageHeader": return 1
		case "DataSetMessageHeader": return 2
		case "SingleDataSetMessage": return 4
		case "PublisherId": return 8
		case "DataSetClassId": return 16
		case "ReplyTo": return 32
		default:
		return 0
	}
}
...
func JSONDataSetMessageContentMaskFromString(s string) JSONDataSetMessageContentMask {
	switch s {
		case "None": return 0
		case "DataSetWriterId": return 1
		case "MetaDataVersion": return 2
		case "SequenceNumber": return 4
...
func BrokerTransportQoSFromString(s string) BrokerTransportQoS {
	switch s {
		...
		case "AtLeastOnce": return 2
		case "AtMostOnce": return 3
		case "ExactlyOnce": return 4
		default:
		return 0
	}
}
...
func PermissionTypeFromString(s string) PermissionType {
	switch s {
		...
		case "ReadRolePermissions": return 2
		case "WriteAttribute": return 4
		case "WriteRolePermissions": return 8
		case "WriteHistorizing": return 16
		case "Read": return 32
		case "Write": return 64
		case "ReadHistory": return 128
		case "InsertHistory": return 256
		case "ModifyHistory": return 512
		case "DeleteHistory": return 1024
		case "ReceiveEvents": return 2048
		case "Call": return 4096
		case "AddReference": return 8192
		case "RemoveReference": return 16384
		case "DeleteNode": return 32768
		case "AddNode": return 65536
		default:
		return 0
	}
}
...
func AccessLevelTypeFromString(s string) AccessLevelType {
	switch s {
		case "None": return 0
		case "CurrentRead": return 1
		case "CurrentWrite": return 2
		case "HistoryRead": return 4
		case "HistoryWrite": return 8
		case "SemanticChange": return 16
		case "StatusWrite": return 32
		case "TimestampWrite": return 64
		default:
		return 0
	}
}
...
func AccessLevelExTypeFromString(s string) AccessLevelExType {
	switch s {
		...
		case "StatusWrite": return 32
		case "TimestampWrite": return 64
		case "NonatomicRead": return 256
		case "NonatomicWrite": return 512
		case "WriteFullArrayOnly": return 1024
		default:
		return 0
	}
}
...
func EventNotifierTypeFromString(s string) EventNotifierType {
	switch s {
		case "None": return 0
		case "SubscribeToEvents": return 1
		case "HistoryRead": return 4
		case "HistoryWrite": return 8
		default:
		return 0
...
func AccessRestrictionTypeFromString(s string) AccessRestrictionType {
	switch s {
		case "None": return 0
		case "SigningRequired": return 1
		case "EncryptionRequired": return 2
		case "SessionRequired": return 4
		default:
		return 0
	}
}
...
func StructureTypeFromString(s string) StructureType {
	switch s {
		...
		case "StructureWithOptionalFields": return 1
		case "Union": return 2
		default:
		return 0
	}
...
func ApplicationTypeFromString(s string) ApplicationType {
	switch s {
		...
		case "ClientAndServer": return 2
		case "DiscoveryServer": return 3
		default:
		return 0
	}
}
...
func NodeAttributesMaskFromString(s string) NodeAttributesMask {
	switch s {
		case "None": return 0
		case "AccessLevel": return 1
		case "ArrayDimensions": return 2
		case "BrowseName": return 4
		case "ContainsNoLoops": return 8
		case "DataType": return 16
		case "Description": return 32
		case "DisplayName": return 64
		case "EventNotifier": return 128
		case "Executable": return 256
		case "Historizing": return 512
		case "InverseName": return 1024
		case "IsAbstract": return 2048
		case "MinimumSamplingInterval": return 4096
		case "NodeClass": return 8192
		case "NodeId": return 16384
		case "Symmetric": return 32768
		case "UserAccessLevel": return 65536
		case "UserExecutable": return 131072
		case "UserWriteMask": return 262144
		case "ValueRank": return 524288
		case "WriteMask": return 1048576
		case "Value": return 2097152
		case "DataTypeDefinition": return 4194304
		case "RolePermissions": return 8388608
		case "AccessRestrictions": return 16777216
		case "All": return 33554431
		case "BaseNode": return 26501220
		case "Object": return 26501348
		case "ObjectType": return 26503268
		case "Variable": return 26571383
		case "VariableType": return 28600438
		case "Method": return 26632548
		case "ReferenceType": return 26537060
		case "View": return 26501356
		default:
		return 0
	}
}
...
func AttributeWriteMaskFromString(s string) AttributeWriteMask {
	switch s {
		...
		case "ValueRank": return 524288
		case "WriteMask": return 1048576
		case "ValueForVariableType": return 2097152
		case "DataTypeDefinition": return 4194304
		case "RolePermissions": return 8388608
		case "AccessRestrictions": return 16777216
		case "AccessLevelEx": return 33554432
		default:
		return 0
	}
}
...
func BrowseResultMaskFromString(s string) BrowseResultMask {
	switch s {
		case "None": return 0
		case "ReferenceTypeId": return 1
		case "IsForward": return 2
		case "NodeClass": return 4
		case "BrowseName": return 8
		case "DisplayName": return 16
		case "TypeDefinition": return 32
		case "All": return 63
		case "ReferenceTypeInfo": return 3
		case "TargetInfo": return 60
		default:
		return 0
	}
}
...
func FilterOperatorFromString(s string) FilterOperator {
	switch s {
		...
		case "InList": return 9
		case "And": return 10
		case "Or": return 11
		case "Cast": return 12
		case "InView": return 13
		case "OfType": return 14
		case "RelatedTo": return 15
		case "BitwiseAnd": return 16
		case "BitwiseOr": return 17
		default:
		return 0
	}
}
...
func DataChangeTriggerFromString(s string) DataChangeTrigger {
	switch s {
		...
		case "StatusValue": return 1
		case "StatusValueTimestamp": return 2
		default:
		return 0
	}
}
...
func ServerStateFromString(s string) ServerState {
	switch s {
		...
		case "NoConfiguration": return 2
		case "Suspended": return 3
		case "Shutdown": return 4
		case "Test": return 5
		case "CommunicationFault": return 6
...
func ModelChangeStructureVerbMaskFromString(s string) ModelChangeStructureVerbMask {
	switch s {
		case "NodeAdded": return 1
		case "NodeDeleted": return 2
		case "ReferenceAdded": return 4
		case "ReferenceDeleted": return 8
		case "DataTypeChanged": return 16
		default:
		return 0
	}
}
...
func ExceptionDeviationFormatFromString(s string) ExceptionDeviationFormat {
	switch s {
		case "AbsoluteValue": return 0
		case "PercentOfValue": return 1
		case "PercentOfRange": return 2
		case "PercentOfEURange": return 3
