...
func TestDecodeHello(t *testing.T) {
	...
	case h.EndPointURL.Get() != "opc.tcp://wow.its.easy:11111/UA/Server":
		t.Errorf("EndPointURL doesn't match. Want: %s, Got: %s", "opc.tcp://wow.its.easy:11111/UA/Server", h.EndPointURL.Get())
	}
	t.Log(h.String())
}
