...
func newBasic256Rsa256Symmetric(localNonce []byte, remoteNonce []byte) *EncryptionAlgorithm {
...
func newBasic256Rsa256Asymmetric(localKey *rsa.PrivateKey, remoteKey *rsa.PublicKey) *EncryptionAlgorithm {
	e := new(EncryptionAlgorithm)
