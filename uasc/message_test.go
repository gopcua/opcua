...
func TestMessage(t *testing.T) {
	cases := []CodecTestCase{
		...
		// 	Struct: func() interface{} {
		// 		s := &SecureChannel{
		// 			endpointURL: "opc.tcp://192.168.118.199:4840",
		// 			cfg: &Config{
		// 				SecurityPolicyURI: "opc.tcp://192.168.118.199:4840/FOO",
		// 			},
		// 		}
		// 		instance := &channelInstance{
		// 			sc:              s,
		...
		// 				RequestHeader: &ua.RequestHeader{
		// 					AuthenticationToken: ua.NewTwoByteNodeID(0),
		// 					Timestamp:           time.Date(2024, time.May, 30, 16, 17, 44, 0, time.Local),
		// 					RequestHandle:       1,
		// 					ReturnDiagnostics:   0,
		// 					TimeoutHint:         10000,
		// 					AdditionalHeader:    ua.NewExtensionObject(nil),
		...
		// 		// Chunk Type: Final
		// 		0x46,
		// 		0x77, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x22, 0x00, 0x00, 0x00, 0x6f, 0x70, 0x63, 0x2e, 0x74, 0x63, 0x70, 0x3a, 0x2f, 0x2f, 0x31, 0x39, 0x32, 0x2e, 0x31, 0x36, 0x38, 0x2e, 0x31, 0x31, 0x38, 0x2e, 0x31, 0x39, 0x39, 0x3a, 0x34, 0x38, 0x34, 0x30, 0x2f, 0x46, 0x4f, 0x4f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0xbe, 0x01, 0x00, 0x00, 0x00, 0x04, 0xd5, 0xd8, 0x69, 0xb2, 0xda, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x10, 0x27, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0xee, 0x36, 0x00,
		// 	},
		// },
	}
...
func BenchmarkEncodeMessage_WithCodec(b *testing.B) {
	cases := []CodecTestCase{
		{
			Name: "OPN",
			Struct: func() interface{} {
	...
	for i := 0; i < b.N; i++ {
		for _, tc := range cases {
			_, err := codec.Marshal(tc.Struct)
			if err != nil {
				b.Fatalf("fail to encode message, err: %v", err)
			}
		}
	}
}
